...
Widget rowtext({required String titles}){
  return Row(
    children: [
      boldText(title: '${titles} ', fontSize: AppTextSize.regular, color: AppColor.blackColor),
      boldText(title: '*', fontSize: AppTextSize.medium, color: AppColor.errorColor),
    ],
  );
}
